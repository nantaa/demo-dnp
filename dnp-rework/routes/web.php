...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/jobs/{job}/reschedule', [JobController::class, 'reschedule'])->name('jobs.reschedule');
    Route::post('/jobs/{job}/payment-verification', [JobController::class, 'savePaymentVerification'])->name('jobs.payment-verification');
